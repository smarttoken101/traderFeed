            ...
            <div className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <span>
                {assetNews.articles.length > 0 
                  ? `Latest: ${formatRelativeTime(assetNews.articles[0].publishedAt)}`
                  : 'No recent updates'
                }
              </span>
            </div>
          ...
          {assetNews.articles.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                No news found for {asset.toUpperCase()}
              </h3>
              <p className="text-gray-600 mb-4">
                This asset hasn't been mentioned in recent news articles.
              </p>
              <button
                onClick={() => navigate('/')}
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card text-center">
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {assetNews.articles.filter(a => a.sentimentLabel === 'positive').length}
              </div>
              <div className="text-sm text-success-600">Positive Articles</div>
            </div>

            <div className="card text-center">
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {assetNews.articles.filter(a => a.sentimentLabel === 'negative').length}
              </div>
              <div className="text-sm text-danger-600">Negative Articles</div>
            </div>

            <div className="card text-center">
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {assetNews.articles.filter(a => a.sentimentLabel === 'neutral').length}
              </div>
