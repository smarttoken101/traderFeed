...
export const ASSET_MAPPING = {
  ...
  commodities: {
    'GOLD': ['gold', 'xauusd', 'xau/usd', 'xau usd', 'gold futures', 'gc'],
    'SILVER': ['silver', 'xagusd', 'xag/usd', 'xag usd', 'silver futures', 'si'],
    'OIL': ['crude oil', 'oil', 'wti', 'brent', 'cl', 'bz', 'crude', 'petroleum'],
    'NATGAS': ['natural gas', 'natgas', 'ng', 'henry hub', 'gas futures'],
    'COPPER': ['copper', 'hg', 'copper futures'],
    'PLATINUM': ['platinum', 'pl', 'platinum futures'],
    'PALLADIUM': ['palladium', 'pa', 'palladium futures'],
    'WHEAT': ['wheat', 'w', 'wheat futures'],
    'CORN': ['corn', 'c', 'corn futures'],
    'SOYBEANS': ['soybeans', 's', 'soybean futures'],
    'COFFEE': ['coffee', 'kc', 'coffee futures'],
    'SUGAR': ['sugar', 'sb', 'sugar futures'],
    'COTTON': ['cotton', 'ct', 'cotton futures'],
    'LUMBER': ['lumber', 'lumber futures']
  },
  stocks: {
    'SPX': ['s&p 500', 'spx', 'sp500', 's&p500', 'spy', 'es'],
    'NDX': ['nasdaq', 'ndx', 'nasdaq 100', 'qqq', 'nq'],
    'DJI': ['dow jones', 'dji', 'dow', 'dia', 'ym'],
    'RUSSELL': ['russell 2000', 'rut', 'iwm', 'rty'],
